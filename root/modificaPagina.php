...
<h1 style=\"text-align: center;\">
    ...
    <form method=\"GET\" action=\"modificaPagina.php\">
        ...
        <textarea cols=\"100\" rows=\"20\" name=\"testo\">".$jsondecode->testo."</textarea><br>
...
if(isset($ID) && ($oldnome) && ($nome) && ($testo) && ($tags))
{
    ...
    $getList = file_get_contents("".FULL_PATH."database/liste/listaPagine.html");
    $parseList = str_replace($oldnome, $nome, $getList);
    file_put_contents("".FULL_PATH."database/liste/listaPagine.html", $parseList);
